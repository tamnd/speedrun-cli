...
Most of these come down to network reality or how speedrun serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

speedrun rate-limits like any public site. speedrun already paces
...
Where a surface is gated, speedrun reads a cookie or token you supply
...
`speedrun`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what speedrun actually did
