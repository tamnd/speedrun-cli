...
// HTTP behaviour is covered in speedrun_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "speedrun://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("speedrun", "about")
	if err != nil || got.String() != "speedrun://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want speedrun://page/about", got.String(), err)
	}
}
